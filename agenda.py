...
def main():
    # Uso de la estructura de datos: Diccionario (Clave: Nombre, Valor: Teléfono)
    contactos = {}
    ...
    while True:
        ...
        if opcion == "1":
            # OPERACIÓN 1: Insertar/Agregar o actualizar datos
            ...
            if nombre and telefono:
                ...
                print("⚠️ El nombre y el teléfono no pueden estar vacíos.")
            ...
            if nombre in contactos:
                ...
                print(f"🗑️ Contacto '{nombre}' eliminado con éxito.")
            else:
